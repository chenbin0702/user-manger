      ...
      <el-form
        ...
        <el-form-item label="处理结果" prop="result">
          <el-radio-group v-model="processForm.result">
            <el-radio label="complete">完成</el-radio>
    ...
    <el-dialog
      ...
      <el-descriptions :column="2" border>
        ...
        <el-descriptions-item label="学习进度">
          <el-progress :percentage="currentOrder?.progress" />
...
const orders = ref([
  {
    orderNo: 'CO20240120001',
    courseName: '无人机驾驶基础课程',
    studentName: '张三',
    phone: '13800138000',
    amount: 1999.00,
    progress: 45,
  ...
  {
    orderNo: 'CO20240120002',
    courseName: '无人机维修技能课程',
    studentName: '李四',
    phone: '13900139000',
    amount: 2999.00,
    progress: 0,
